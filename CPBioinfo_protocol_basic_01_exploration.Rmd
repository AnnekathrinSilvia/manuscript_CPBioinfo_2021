...
Navigate to the Samples View panel (Fig. X) as explained before. 
...
Use teh 'Group/color by' option to color the samples by condition - the PCA plot should now display the samples in 4 colors (Fig. X). 
...
The default number is set too 300 genes. 
...
The values of the percent of variance explained of the first and second principal component should have changed. 
