...
In this protocol, we describe how to launch a Shiny application [@shiny2021] of pcaExplorer with the data of the macrophage dataset [@Alasoo2018], which is also distributed as a Bioconductor [@Huber2015] package. 
