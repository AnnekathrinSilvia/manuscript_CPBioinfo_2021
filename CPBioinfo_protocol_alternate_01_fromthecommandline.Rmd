---
title: >
  CPBioinfo_protocol_alternate_01_fromthecommandline
author:
...
knitr::kable(pcs_enrichment$PC1$posLoad)
knitr::kable(pcs_enrichment$PC1$negLoad)
knitr::kable(pcs_enrichment$PC2$posLoad)
knitr::kable(pcs_enrichment$PC2$negLoad)
```
