...
In this protocol, we will assemble a compact end-to-end analysis for the macrophage dataset, starting from the quantifications provided in the omonymous Bioconductor package [@Alasoo2018].
...
Generare the corresponding annotation table for `dds_macrophage`, and store that as `anno_df`.
